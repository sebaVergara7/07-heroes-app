...
describe('Pruebas en HeroScreen.test.js', () => {

    test('no debe de mostrar el HeroeScreen si no hay un héroe en el URL', () => {
    ...
    test('debe de mostrar un héroe si el parametro existe y se encuentra', () => {
